-- CLEAN SUBSCRIPTION PLANS TABLE CREATION
...
BEGIN
    ...
    RAISE NOTICE '📋 Default plans added: Free ($0), Pro ($19.99), Premium ($49.99)';
    RAISE NOTICE '🎯 Plans tab should now be visible in admin panel';
    RAISE NOTICE '🔄 Refresh your browser and go to /admin/subscriptions';
END $$;