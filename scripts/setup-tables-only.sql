-- SETUP TABLES ONLY (No user creation)
-- Run this first to create all the database structure
...
-- Step 4: Drop existing policies (if any) and create new ones
...
-- Step 6: Create a function to handle new user signups
...
-- Success message
SELECT 'Database tables and functions created successfully! Now sign up with mike@mikerobinson.co.nz' as status;