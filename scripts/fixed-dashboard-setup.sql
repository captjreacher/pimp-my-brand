-- FIXED SUPABASE DASHBOARD SETUP SCRIPT
...
ON CONFLICT (email) DO UPDATE SET
    ...
    full_name = 'Mike Robinson (Super Admin)';
...
-- Success message
SELECT 'Database setup complete! Mike Robinson admin account is ready.' as status;