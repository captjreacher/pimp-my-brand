// Test script for nuclear reset verification
...
async function testNuclearReset() {
  console.log('🚀 Testing Nuclear Reset and Fresh Admin Setup\n');
  ...
  try {
    ...
    if (adminCheckError) {
      console.error('❌ Admin user not found:', adminCheckError.message);
      return false;
    }
