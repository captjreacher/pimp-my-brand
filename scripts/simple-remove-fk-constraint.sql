-- Simple script to remove foreign key constraint and create admin
-- Run this in your Supabase SQL Editor

-- Step 1: Disable RLS temporarily
ALTER TABLE public.profiles DISABLE ROW LEVEL SECURITY;

-- Step 2: Remove the foreign key constraint that's causing issues
...
-- Step 4: Create admin user without foreign key constraint (simple INSERT)
-- IMPORTANT: Replace 'your-email@example.com' with your actual email
