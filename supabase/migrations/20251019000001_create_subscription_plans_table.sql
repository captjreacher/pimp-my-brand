...
CREATE TABLE IF NOT EXISTS public.subscription_plans (
  ...
  UNIQUE(tier, is_active) DEFERRABLE INITIALLY DEFERRED
);
...
-- Create function to get plan by tier (for backward compatibility)
...
-- Create function to get all active plans for public display
...
-- Add comment
COMMENT ON TABLE public.subscription_plans IS 'Admin-managed subscription plans with configurable pricing, features, and limits';